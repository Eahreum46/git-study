...
//서로 다른 배열을 하나로 합쳐주는 메서드 함수/ 예전엔 concat만 있었는데 요즘엔 배열함수를 사용하는 경우가 많아짐
...
// slice(인덱스,인덱스) => 문자열 slice()
// 첫번째 인덱스 값부터 시자해서 두번째 인덱스 값 바로 직전까지
