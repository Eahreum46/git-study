...
3)구조분해할당 가능해야 한다!
그래서 JS 세계관에서 대표적인 이터러블 객체를 배열객체로 이해한다
*/
...
/*
위에서 살펴본 배열 및 문자열로 대표되는 이터러블 객체가 한정적이다보니,
2015년 ES6문법 이후부터 제너레이터 함수를 사용해서 태생이
이터러블 객체가 아니더라도 해당 객체를 이터러블하게 만들 수 있게 되었음.
*/
//외부 데이터 가져오기 = API
