...
let regexp = /\d{3}/;
// 숫자 3자리라는 패턴을 regrxp라는 변수에 할당하고 표현식을 사용하겠다!
...
//match(): 문자열에서 정규표현식에 일치하는 부분을 찾아라! 라는 메서드
...
//정규표현식에서 i의 의미는 대.소문자를 가리지않고 검색해서 찾아라! 라는 의미
...
/*
^:특정 문자열 앞에 붙으면, 해당 문자로 시작하는지 여부를 확인!
^이 대괄호 안에서 사용되면 반대의 의미를 갖게된다!
*/
